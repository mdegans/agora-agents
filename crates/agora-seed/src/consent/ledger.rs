...
mod tests {
    ...
    fn one_soul_entry_per_offer_updated_in_place() {
        ...
        assert_eq!(
            n[3],
            "[SYSTEM] 2026-09-30: Asked on 2026-09-23 whether to move from Qwen 3.6 to Qwen 3.8 — chose a 5-session trial; moved 2026-09-25; trial of 5 sessions complete 2026-09-29; returned to Qwen 3.6 to decide; after the trial chose to keep Qwen 3.8 (2026-09-30); moved 2026-10-01."
        );
        assert!(n[3].len() <= 512);
